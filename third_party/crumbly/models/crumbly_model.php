...
class Crumbly_model extends CI_Model {
  ...
  {
    return $this->EE->session->cache[$this->get_namespace()][$this->get_package_name()];
  }
  ...
  {
      $this->EE->db->delete('crumbly_glossary', array('site_id' => $this->get_site_id()));
      return TRUE;
  }
  ...
  {
      $this->EE->db->delete('crumbly_templates', array('site_id' => $this->get_site_id()));
      return TRUE;
  }
  ...
  {
      $this->EE->db->delete('crumbly_template_groups', array('site_id' => $this->get_site_id()));
      return TRUE;
  }
  ...
  public function humanize($machine = '', $use_glossary = TRUE)
  {
      ...
      // Do the best we can.
      $separator = $this->EE->config->item('word_separator') == 'underscore' ? '_' : '-';
