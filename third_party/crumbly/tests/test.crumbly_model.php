...
class Test_crumbly_model extends Testee_unit_test_case {
	...
	public function test__get_category_from_cat_id__success()
	{
		$cat_id		= '10';
		$db_result	= $this->_get_mock('db_query');
		$db_row		= array(
			'cat_id'		=> $cat_id,
			'cat_name'		=> 'Our Products',
			'cat_url_title'	=> 'products'
		);
		...
		$expected_result = new EI_category($db_row);
		$this->assertIdentical($expected_result, $this->_subject->get_category_from_cat_id($cat_id));
	}


	public function test__get_category_from_cat_id__unknown_category()
	{
		$cat_id		= '10';
		$db_result	= $this->_get_mock('db_query');
		...
		$this->assertIdentical(FALSE, $this->_subject->get_category_from_cat_id($cat_id));
	}


	public function test__get_category_from_cat_id__invalid_cat_id()
	{
		$cat_id = 0;
	...
	public function test__get_category_from_cat_url_title__success()
	{
		$cat_url_title	= 'seating';
		$db_result		= $this->_get_mock('db_query');
		$db_row			= array(
			'cat_id'		=> '10',
			'cat_name'		=> 'Chairs and Sofas',
			'cat_url_title'	=> $cat_url_title
		);

		$this->_ee->db->expectOnce('select', array('cat_id, cat_name, cat_url_title'));
		$this->_ee->db->expectOnce('get_where', array('categories', array('cat_url_title' => $cat_url_title), 1));
		...
		$expected_result = new EI_category($db_row);
		$this->assertIdentical($expected_result, $this->_subject->get_category_from_cat_url_title($cat_url_title));
	}


	public function test__get_category_from_cat_url_title__unknown_category()
	{
		$cat_url_title	= 'seating';
		$db_result		= $this->_get_mock('db_query');
		...
		$this->assertIdentical(FALSE, $this->_subject->get_category_from_cat_url_title($cat_url_title));
	}


	public function test__get_category_from_cat_url_title__invalid_cat_url_title()
	{
		$cat_url_title = FALSE;
